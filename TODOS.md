...
## Higiene do próprio backlog

### 24 dos 50 itens abertos não têm prioridade — P3

Quase metade do backlog não tem `P1`/`P2`/`P3` no título, o que faz "5 P1"
parecer o topo da pilha quando pode não ser. Apontado na retro de 2026-09-24.

Não é trabalho de código: é uma passada lendo os 24 e marcando. Enquanto não
acontecer, qualquer leitura de prioridade deste arquivo está incompleta por
construção.

**Contexto de como chegou aqui:** a seção `## Completed` existia vazia desde
sempre e 18 itens resolvidos tinham sido apenas riscados no lugar, dentro das
seções abertas — o contador de "abertos" contava resolvido. Os 18 foram movidos
em 2026-09-24. Riscar mantém o item na contagem; mover é o que fecha.
...
> Itens resolvidos, movidos das seções abertas em 2026-09-24. A seção
> existia vazia desde sempre e 18 itens tinham sido apenas riscados no
> lugar — o contador de "abertos" contava resolvido. Riscar mantém o item
> na contagem; mover é o que fecha.
